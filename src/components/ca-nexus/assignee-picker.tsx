...
export function AssigneePicker({
  ...
  const isMaxReached = Boolean(maxSelections && selectedValuesArray.length >= maxSelections);
              ...
              <div className="space-y-1">
                {availableOptions.length === 0 ? (
                  ...
                  availableOptions.map((opt) => {
                    ...
                    const isDisabled = [disabled, opt.isActive === false, isMaxReached && !isSelected].some(Boolean);
                    ...
                    return (
                      ...
                      >
                        <Checkbox
                          ...
                          disabled={[disabled, opt.isActive === false, isMaxReached && !isSelected].some(Boolean)}
                        />
                        {showAvatar && (
                          <Avatar className="h-6 w-6">
                            <AvatarImage src={opt.avatarUrl} alt={opt.name} />
                            ...
                            <div className="flex items-center gap-1.5 ml-auto">
                              <span
                                className={cn(
                                  ...
                                  _getWorkloadColor(opt.workload.utilization),
                                )}
                              >
